...
void* safe_malloc(size_t size, unsigned long line) {
    ...
    if (!result /* or result==NULL */) {
        /* if the allocation was not successful, display an error
         * and exit */
...
/* safe memory allocation function using a pointer to the memory
 * to be allocated */
/* how to call:
 * int * array
 * safeptrmalloc(&array, 10 * sizeof(int));*/
